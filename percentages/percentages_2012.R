...
for (s in seq_along(series_list)){
  if ("2012" %in% names(series_list[[s]])){
    
    # Directors --------------------------------------------------------------
    
    for (i in seq_along(series_list[[s]]$`2012`)){
      serie_m_directors <- as.integer(series_list[[s]]$`2012`[[i]]$directors_gender$male)
      serie_f_directors <- as.integer(series_list[[s]]$`2012`[[i]]$directors_gender$female)
    ...
    for (i in seq_along(series_list[[s]]$`2012`)){
      serie_m_writers <- as.integer(series_list[[s]]$`2012`[[i]]$writers_gender$male)
      serie_f_writers <- as.integer(series_list[[s]]$`2012`[[i]]$writers_gender$female)
    ...
    for (i in seq_along(series_list[[s]]$`2012`)){
      serie_m_producers <- as.integer(series_list[[s]]$`2012`[[i]]$producers_gender$male)
      serie_f_producers <- as.integer(series_list[[s]]$`2012`[[i]]$producers_gender$female)
    ...
    for (i in seq_along(series_list[[s]]$`2012`)){
      serie_m_sound <- as.integer(series_list[[s]]$`2012`[[i]]$sound_gender$male)
      serie_f_sound <- as.integer(series_list[[s]]$`2012`[[i]]$sound_gender$female)
    ...
    for (i in seq_along(series_list[[s]]$`2012`)){
      serie_m_music <- as.integer(series_list[[s]]$`2012`[[i]]$music_gender$male)
      serie_f_music <- as.integer(series_list[[s]]$`2012`[[i]]$music_gender$female)
    ...
    for (i in seq_along(series_list[[s]]$`2012`)){
      serie_m_art <- as.integer(series_list[[s]]$`2012`[[i]]$art_gender$male)
      serie_f_art <- as.integer(series_list[[s]]$`2012`[[i]]$art_gender$female)
    ...
    for (i in seq_along(series_list[[s]]$`2012`)){
      serie_m_makeup <- as.integer(series_list[[s]]$`2012`[[i]]$makeup_gender$male)
      serie_f_makeup <- as.integer(series_list[[s]]$`2012`[[i]]$makeup_gender$female)
    ...
    for (i in seq_along(series_list[[s]]$`2012`)){
      serie_m_costume <- as.integer(series_list[[s]]$`2012`[[i]]$costume_gender$male)
      serie_f_costume <- as.integer(series_list[[s]]$`2012`[[i]]$costume_gender$female)
...
# Creating a dataset percentages_2012  ----------------------------------------

percentages_2012 <- data.frame(year = 2012, 
